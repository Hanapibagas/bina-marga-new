            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">Daftar Struktur Organisasi</h4>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton5">
                                <a style="margin-bottom: 10px; margin-top: 10px; cursor: pointer;" class="dropdown-item"
                                    data-toggle="modal" data-target="#exampleModalCenterUser"><i
                                        style="font-size: 25px;" class="ri-user-fill"></i>Struktur Organisasi +</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('postStrukturOrganisasi') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" id="addSubBagian" class="btn btn-info">Tambah Nama SubBagian</button>
